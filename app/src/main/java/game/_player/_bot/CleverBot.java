...
public class CleverBot extends Bot {
    ...
    public static final String NAME = "clever";

    public CleverBot(List<Card> initialCards, List<Card> initialSharedCards, boolean isAuto, List<List<Card>> autoMovements) {
    ...
    public Card discardCard() {
        // TODO: implement a clever bot
        // random behaviour for now
