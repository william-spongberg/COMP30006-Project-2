 ...
 * Scorer.java
 * 
 * Represents the scorer in the game.
 * which contains the class Scorer.
 * which is used to score the game and find the winner.
 * using the scoring cases and summing options.
 * 
